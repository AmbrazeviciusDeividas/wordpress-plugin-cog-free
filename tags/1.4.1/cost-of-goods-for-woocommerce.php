 ...
 */
define('COST_OF_GOODS_FOR_WOOCOMMERCE_VERSION', '1.4.1');
...
function COGWPIRON_activate_cost_of_goods_for_woocommerce()
{
    ...
    COGWPIRON_send_activation_request('Cost Of Goods', true);
...
function COGWPIRON_deactivate_cost_of_goods_for_woocommerce()
{
    ...
    COGWPIRON_send_activation_request('Cost Of Goods', false);
...
function COGWPIRON_generateUUIDv4(): string
{
    return sprintf(
...
function COGWPIRON_send_activation_request($pluginName, $active) {
    ...
    $inner_data = [
        ...
        'userId' => strval(COGWPIRON_generateUUIDv4()), // Ensure you have defined generateUUIDv4() function
